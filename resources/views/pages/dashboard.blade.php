...
@if(auth()->user()->role_id == 1 || auth()->user()->role_id == 2 )
    <div class="content">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
             ...
             @if(auth()->user()->planning_tools == "1")
            <a href="{{route('editworkflow')}}" style="text-decoration: none;">
            <div class="col-lg-4 col-md-6 col-sm-6">
    ...
    @if(auth()->user()->role_id == 3)
         <div class="content">
        <div class="row">
            @if(Auth::user()->is_profile_complete == 1 || auth()->user()->preworkshop_survey == "0")
            <a href="#" style="text-decoration:none">
             <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-stats grayout">
                    <div class="card-body">
            ...
            @else
            <!-- @if(auth()->user()->preworkshop_survey == "1") -->
            <a href="{{route('getPreWorkshopSurvey')}}" style="text-decoration:none">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-stats clickable">
                    <div class="card-body ">
                         <div class="row">
            ...
            <!-- @endif -->
            @endif
            @if(Auth::user()->show_feedback == 1 || auth()->user()->feedback_survey == "1")
            <a href="{{route('feedbackDashboard')}}" style="text-decoration: none;">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-stats clickable">
                    <div class="card-body ">
                        <div class="row">
...
<!--     @include('pages.js.preworkshop_chart') -->
@if($is_feedback_show==1)
