                ...
                <h3>Objectives</h3>
                  ...
                  <div class="col-lg-1 col-md-2 col-sm-3">
                       ...
                       <div class="col-lg-11 col-md-10 col-sm-8  pl-sm-2">
                           <input type="text"  name="background"  class="form-control background_input" value="{{ isset($your_Objectives[0]->background) ? $your_Objectives[0]->background : '' }}">
                                    ...
                                    <div id="yourexample{{ $i }}" class="card-body collapse show" data-parent="#youraccordion">
                                        ...
                                        <div class="form-group form-inline justify-content-between">
                                            ...
                                            <!-- <button type="button" class="btn tooltip-q" data-toggle="tooltip" data-placement="left" title="There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,">
                                             ...
                                             <a href="{{url('objectives/your_delete')}}/{{ $objective->id}}"><button class="remove_objective" data-id=""><i class="fa3 fa-times-circle"></i></button></a>    
                                        </div>
                                ...
                                <div class="card mb-0">
                                    ...
                                    <div id="theirexample{{$i}}" class="card-body collapse show" data-parent="#theiraccordion">
                                        ...
                                        <div class="form-group form-inline justify-content-between">
                                            ...
                                            <a href="{{url('objectives/their_delete')}}/{{ $objective->id}}"><button class="remove_objective" data-id=""><i class="fa3 fa-times-circle"></i></button></a>    
                                        </div>
                        ...
                        <div class="messaging external">
                            ...
                            <div class="table-responsive-sm">
                                <table class="table table-bordered table-communication ">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col"><a href="javascript:void(0);" style="font-size:18px;" title="Add More row"><span class="fas fa-plus-circle ques"></span></a></th>
                                            <th scope="col">Questions </th>
                                            <th scope="col "  style="width:150px;">Who To Ask</th>
                                            <th scope="col" style="width:400px;">Why Are You Asking It</th>
                                            <th scope="col" ></th>
                                        </tr>
                                    </thead>
                                    <tbody id="queTable">
                                        ...
                                        <tr class="row{{$data->id}}" id="{{$data->id}}">
                                            <td>{{$z}}</td>
                                            <td><input type="text" id="ques{{$data->id}}" class="form-control" value="{{$data->ques}}"></td>
                                            <td><input type="text" id="who_to_ask{{$data->id}}" class="form-control" value="{{$data->who_to_ask}}"></td>
                                            <td><input type="text" id="how_you_ask_it{{$data->id}}" class="form-control" value="{{$data->how_you_ask_it}}"></td>
                                        ...
                                        <tr class="row1" id="1">
                                            <td>1</td>
                                            <td><input type="text" id="ques1" class="form-control"></td>
                                            <td><input type="text" id="who_to_ask1" class="form-control"></td>
                                            <td><input type="text" id="how_you_ask_it1" class="form-control"></td>
                                            <td><button class="removeButton RemoveQues"><i class="fas fa-times-circle"></i></button></td>
                                        </tr>
                                        @endif
                                    </tbody>
