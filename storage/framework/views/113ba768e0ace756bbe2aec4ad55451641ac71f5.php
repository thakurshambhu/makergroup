...
<head>
  ...
  <link href="<?php echo e(asset('landing_page')); ?>/css/slick.css" rel="stylesheet"/>
  <link href="<?php echo e(asset('landing_page')); ?>/css/slick-theme.css" rel="stylesheet"/>
...
<body id="page-top">
  ...
  <?php echo $__env->make('layouts.headers.inner_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <!-- jquery_session.js -->
  ...
  <script src="<?php echo e(asset('landing_page')); ?>/js/jquery_session.js"></script>
  <script src="<?php echo e(asset('landing_page')); ?>/js/slick.min.js"></script>
...
</html><?php /**PATH C:\xampp\htdocs\Makergroup\resources\views/layouts/inner_main.blade.php ENDPATH**/ ?>