            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 order-xl-6">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo e(route('saveAdmin')); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <input type="hidden" name="role_id" id="input-role" class="form-control form-control-alternative" value="2" required>
                                    </div>
...
<?php echo $__env->make('layouts.app', [
    'class' => '',
    'elementActive' => 'admin',
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Makergroup\resources\views/pages/add_admin.blade.php ENDPATH**/ ?>