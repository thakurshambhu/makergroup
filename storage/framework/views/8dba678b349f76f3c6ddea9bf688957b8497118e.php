...
<form method="POST" action="<?php echo e(route('saveContactUs')); ?>" id="contactForm">
          ...
          <div class="form-group wow fadeIn">
            ...
            <div class="form-group wow fadeIn">
            <input type="checkbox" name="policy"> I have read and agree to the <a style="color:#007bff;" href="<?php echo e('terms'); ?>">Terms of Use</a>, as well as the <a style="color:#007bff;" href="<?php echo e('policy'); ?>">Privacy Policy</a>.
          </div>
...
<?php /**PATH C:\xampp\htdocs\Makergroup\resources\views/layouts/page_templates/form.blade.php ENDPATH**/ ?>